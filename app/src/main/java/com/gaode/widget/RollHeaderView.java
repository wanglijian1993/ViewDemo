...
import com.gaode.R;
import com.gaode.utils.DisplayUtil;
...
//        mViewPager.setLayoutParams(vParams);
     ...
     * @param alpha
     */
    public void refreshImageViewAlpha(float alpha) {
        v.setAlpha(alpha);
    }
    ...
    public void setImgUrlData(List<String> urlList) {
        ...
        if (mUrlList != null && !mUrlList.isEmpty()) {
            ...
            for (int i = 0; i < mUrlList.size(); i++) {
                ...
                if (i == 0) {
                    dotIv.setBackgroundResource(R.mipmap.tuoyuan4);
                } else {
                    dotIv.setBackgroundResource(R.mipmap.tuoyuan5);
                }
                //设置点的间距
    ...
    public void onPageSelected(int position) {
        dotList.get(prePosition).setBackgroundResource(R.mipmap.tuoyuan5);
        dotList.get(position % dotList.size()).setBackgroundResource(R.mipmap.tuoyuan4);
    ...
    private class MyAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            //加载图片
//            Picasso.with(mContext).load(mUrlList.get(position % mUrlList.size())).into(iv);
               iv.setImageResource(R.mipmap.lunbotu);
